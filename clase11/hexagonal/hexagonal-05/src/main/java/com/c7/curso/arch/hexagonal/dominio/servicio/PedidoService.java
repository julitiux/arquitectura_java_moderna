...
public interface PedidoService {
    ...
    /**
     * Procesa el pago de un pedido especificado utilizando los detalles de pago proporcionados.
     *
     * @param pedidoId Identificador del pedido que se quiere pagar.
     * @param detallesPago Objeto que contiene la información necesaria para realizar el pago,
     *                     como el número de tarjeta, nombre del titular, fecha de expiración,
     *                     código de seguridad y monto del pago.
     */
    void procesarPago(Long pedidoId, DetallesPago detallesPago);
}
