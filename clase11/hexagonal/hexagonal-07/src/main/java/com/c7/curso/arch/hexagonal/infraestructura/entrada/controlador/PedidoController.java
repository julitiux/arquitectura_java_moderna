...
public class PedidoController {
    ...
    @PutMapping("/{pedidoId}")
    public ResponseEntity<Void> pagarPedido(@PathVariable Long pedidoId, @RequestBody DetallesPago detallesPago) {
        pedidoService.procesarPago(pedidoId, detallesPago);
